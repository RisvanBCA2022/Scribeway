            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[800px] text-center">
                ...
                <p className="mb-12 text-base !leading-relaxed text-body-color dark:text-body-color-dark sm:text-lg md:text-xl">
                  Every great writer was once a beginner. Start blogging today
                  and let your words pave the path to your journey as a writer,
                  sharing your thoughts, experiences, and insights with the
                  world!.
                </p>
